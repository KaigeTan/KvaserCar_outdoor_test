...
class PlotNode(Node):
    ...
    def ego_start_cb(self, msg: Point):
        self.ego_path_start = (msg.x, msg.y)

    def ego_end_cb(self, msg: Point):
        self.ego_path_end = (msg.x, msg.y)

    def adv_start_cb(self, msg: Point):
        self.adv_path_start = (msg.x, msg.y)
    ...
    def update(self, frame):
        ...
        if self.adv_path_start and self.adv_path_end:
            xs = [self.adv_path_start[0], self.adv_path_end[0]]
            ys = [self.adv_path_start[1], self.adv_path_end[1]]
